...
<form class="form-inline" action="{FORM_ACTION}" method="post" id="ffields" autocomplete="off">
    <div class="table-responsive">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <ul style="padding: 0; list-style: none;">
                            ...
                            <!-- END: loop -->
                        </ul> <span style="color: #DB4156"><i class="fa fa-warning"></i> {LANG.field_type_note}<!-- END: field_type --> {FIELD_TYPE_TEXT} 
                    </td>
                </tr>
                    ...
                    <td>
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <tr id="li_{MATCH_TYPE.key}">
                                <td class="w350"><label for="m_{MATCH_TYPE.key}"> <input type="radio" {MATCH_TYPE.checked} id="m_{MATCH_TYPE.key}" value="{MATCH_TYPE.key}" name="match_type"> {MATCH_TYPE.value}
                                </label></td>
                                <td>
                                    <!-- BEGIN: match_input --> <input class="form-control" type="text" value="{MATCH_TYPE.match_value}" name="match_{MATCH_TYPE.key}"{MATCH_TYPE.match_disabled}> <!-- END: match_input -->
                                </td>
                            </tr>
                            <!-- END: match_type -->
                        </table>
        ...
        <table class="table table-striped table-bordered table-hover" id="datefields"{DATAFORM.display_datefields}>
            ...
            <tbody>
                <tr>
                    <td>{LANG.field_default_value}:</td>
                    <td><label> <input type="radio" value="1" name="current_date"{DATAFORM.current_date_1}> {LANG.field_current_date}
                    </label><label> <input type="radio" value="0" name="current_date"{DATAFORM.current_date_0}> {LANG.field_default_date}
                    </label>&nbsp; <input class="form-control date" style="width: 80px" type="text" value="{DATAFORM.default_date}" name="default_date"></td>
                </tr>
                <tr>
    ...
    <input type="hidden" value="{DATAFORM.fid}" name="fid"> <input type="hidden" value="{DATAFORM.field}" name="fieldid">
