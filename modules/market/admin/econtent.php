...
if ($nv_Request->isset_request('submit', 'post')) {
    $row['queue_status'] = $nv_Request->get_editor('econtent_queue_status', '', NV_ALLOWED_HTML_TAGS);
    $row['refresh'] = $nv_Request->get_editor('econtent_refresh', '', NV_ALLOWED_HTML_TAGS);
    $row['terms'] = $nv_Request->get_editor('econtent_terms', '', NV_ALLOWED_HTML_TAGS);
